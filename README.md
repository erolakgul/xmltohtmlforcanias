...
/* BURADA FINT11 İÇİN OLUŞTURALN GRUPTA OLAN KİŞİLERDE ÇALIŞMASI İÇİN KISIT EKLİYORUZ 	RUNFILE @CLSTRFILEPATH; YERİNE OLACAK OLAN KOD BLOKLARI*/
...
/*XML i HTML e dömüştür*/
			CMD = '*cmd.exe /c C:\e-XXXXXX\YYYYYY\tools\transform.bat "' + XMLPATH + '"' + ' "' + XSLTPATH + '" ' + '"' + HTMLPATH + '"';
